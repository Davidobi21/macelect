document.addEventListener("DOMContentLoaded", async function () {
  ...
  try {
    ...
    products.forEach(product => {
      ...
      const cardHTML = `
<div class="product-card bg-white shadow-lg rounded-lg overflow-hidden group flex flex-col w-full max-w-xs mx-auto sm:max-w-sm md:max-w-md lg:max-w-none"
  data-id="${product._id}"
  ...
  <div class="relative">
    ...
    productContainer.innerHTML = `
  <div class="error-container" style="display: flex; juatify-content: center; align-items: center; gap: 60px;  text-align: center;">
