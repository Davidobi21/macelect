...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  try {
    ...
    document.getElementById('product-shipping-info').textContent = `Ships in ${product.shippingInfo || 'N/A'}`;
    ...
    if (productDetailsContainer) {
      productDetailsContainer.innerHTML = '<p class="text-danger">Failed to load product details. Please try again later.</p>';
    }
  }
});
