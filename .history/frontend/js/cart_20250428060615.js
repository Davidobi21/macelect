document.addEventListener("DOMContentLoaded", () => {
    ...
    window.addToCart = function(productId, productName, productPrice, productImage) {
        document.querySelectorAll('.addToCartBtn').forEach((btn) => {
          ...
          const productBtn = document.querySelector('.addToCartBtn');

productBtn.dataset.productId = product.id;
productBtn.dataset.productName = product.name;
productBtn.dataset.productPrice = product.price;
productBtn.dataset.productImage = product.image;
