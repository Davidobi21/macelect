document.addEventListener("DOMContentLoaded", async function () {
  ...
  try {
    ...
    products.forEach(product => {
      ...
      const cardHTML = `
<div class="bg-white shadow-lg rounded-lg overflow-hidden group product-card flex flex-col w-full max-w-xs mx-auto sm:max-w-sm md:max-w-md lg:max-w-none"
  data-id="${product._id}"
