    ...
    try {
      ...
      products.forEach(product => {
        ...
        <div class="col">
            ...
            <!-- Main Image -->
            <img src="${product.images?.[0] ? `http://localhost:5000${product.images[0]}` : ''}" class="card-img-top main-img rounded" alt="${product.name}" style="height: 100%; object-fit: cover;">
            
            <!-- Hover Image -->
            <img src="${product.images?.[1] ? `http://localhost:5000${product.images[1]}` : `http://localhost:5000${product.images[0]}`}" class="card-img-top hover-img position-absolute top-0 start-0 rounded" alt="Hover Image" style="height: 100%; width: 100%; object-fit: cover;">
