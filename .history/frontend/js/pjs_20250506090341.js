...
<div class="bg-white shadow-lg rounded-lg overflow-hidden group product-card" 
  ...
  <div class="error-container" style="display: flex; align-items: center; gap: 60px; max-width: 1500px; text-align: left;">
    ...
    <div class="error-image">
      <img src="/frontend/images/maid-service-cleaner-cleaning-domestic-worker-housekeeper-clean-life-62cf9955822d98773eea18763ae28090.png" alt="Cleaning Lady" style="width: 70px; height: auto;">
    </div>
  </div>`;
  }
