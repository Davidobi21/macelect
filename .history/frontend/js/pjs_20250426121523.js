...
<div class="bg-white shadow-lg rounded-lg overflow-hidden group product-card" 
  ...
  function addToCart(productId, event) {
    ...
    .catch(error => {
      ...
      // Log the full error to get more insights
      if (error.response) {
        console.log('Response Error:', error.response);  // If there's a response error
      } else {
        console.log('Error details:', error);  // Catch the generic error details
      }
