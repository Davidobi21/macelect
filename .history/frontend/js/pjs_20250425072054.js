document.addEventListener("DOMContentLoaded", async function () {
  ...
  try {
    ...
    products.forEach(product => {
      ...
      const productCard = `
      <div class="col">
        <div class="product-card-brand position-relative overflow-hidden rounded-4 shadow-lg" data-name="${product.name}" data-category="${category}" data-price="${product.price}">
