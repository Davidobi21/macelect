                ...
                <div class="overlay position-absolute top-0 bottom-0 start-0 end-0 bg-gradient-to-t from-black opacity-50"></div>
                  ...
                  <p class="text-black font-bold">$${product.price}</p>
                    <div class="d-flex justify-content-between">
                                <button class="btn btn-outline-secondary flex-grow-1 me-2 d-flex align-items-center justify-content-center gap-2">
              <i data-lucide="shopping-cart" class="lucide w-5 h-5"></i>
              <span>Add to Cart</span>
            </button>
            <button class="btn bg-[#09128d] text-white flex-grow-1 d-flex align-items-center justify-content-center gap-2">
              <i data-lucide="credit-card" class="lucide w-5 h-5"></i>
              <span>Buy Now</span>
            </button>
                    </div>
                    </div>
