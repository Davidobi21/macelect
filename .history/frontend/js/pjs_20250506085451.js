...
<div class="bg-white shadow-lg rounded-lg overflow-hidden group product-card" 
  ...
  <div class="error-container text-center py-5">
    <div class="error-text">
      ...
      <p class="text-muted">It looks like something went wrong while loading this page.</p>
      <p class="text-muted">Please try again later or go back to the previous page.</p>
      <a href="javascript:history.back()" class="btn btn-outline-primary mt-3">← Go Back</a>
    </div>
    <div class="error-image mt-4">
      <img src="../images/maid-service-cleaner-cleaning-domestic-worker-housekeeper-clean-life-62cf9955822d98773eea18763ae28090.png" alt="Cleaning Lady" class="img-fluid" style="max-width: 300px;">
    </div>
  </div>`;
  }
