...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const validRoutes = ["/frontend/index.html", "../pages/aboutus.html", "../pages/fqa.html", "../pages/thank-you"];
  ...
  function updateCart(productId, productName, productPrice, productImage) {
    console.log(`Cart updated with product: ${productName}, Price: ${productPrice}, Image: ${productImage}`);
