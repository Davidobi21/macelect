document.addEventListener("DOMContentLoaded", () => {
  ...
  function payWithPaystack() {
    ...
    const totalAmount = total + calculateShippingCost(countrySelect.value, stateSelect.value);
  
    const handler = PaystackPop.setup({
      key: 'pk_test_44f6dbb6159b73b84fff2fc441dcdd997e15c10d', // 🔁 Replace with your Paystack **public** key
      email: email,
      ...
      callback: function(response) {
        ...
        window.location.href = "/thank-you.html"; // 🔁 You can redirect wherever
      },
